...
#process.GlobalTag.globaltag = 'CRUZET3_V6H::All' # or any other appropriate
...
#process.es_prefer = cms.ESPrefer("GlobalTag")
...
#process.DQMStore.referenceFileName = "DQM_L1T_R000050658.root"
