...
if (liveECAL == 1) | (playCMS == 1) :
  if (host == ecalHostEB) | (host == cmsPlayHostEB) :
    onlyEB = 1
    onlyEE = 0
    print "Running EB only."

if (liveECAL == 1) | (playCMS == 1) :
  if (host == ecalHostEE) | (host == cmsPlayHostEE) :
    onlyEB = 0
    onlyEE = 1
...
if (liveCMS == 1) :
  if (fNamePrefix == 'eb') & (host == cmsLiveHostEB) :
    onlyEB = 1
    onlyEE = 0
    print "Running EB only."

if (liveCMS == 1) :
  if (fNamePrefix == 'ee') & (host == cmsLiveHostEE) :
    onlyEB = 0
    onlyEE = 1
    print "Running EE only."
