...
process.add_(
    ...
    outputFileName = cms.untracked.string('%s/iSpy_MWGR%d_%s__COW_.ig' % (process.dqmSaver.dirName.value(),int(dt.date.today().strftime("%W"))+1,dt.date.today().strftime("%Y%m%d"))),
