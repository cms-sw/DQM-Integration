...
# Path
#--------------------------
process.p = cms.Path(process.scalersRawToDigi*process.dqmTKStatus*process.dqmcommon*process.tracking_FirstStep*process.offlinePrimaryVertices*process.monitor)
