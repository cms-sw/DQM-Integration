...
process.EventStreamHttpReader.SelectEvents = cms.untracked.PSet(SelectEvents = cms.vstring('HLT_Jet*','HLT_*Cosmic*','HLT_L1*','HLT_HT*','HLT_*Calibration*','HLT_MinBias*','HLT_Physics*','HLT_Rando*'))
