...
process.EventStreamHttpReader.SelectEvents = cms.untracked.PSet(SelectEvents = cms.vstring('HLT_L1Tech_RPC_TTU_barrel_Cosmics*','HLT_L3MuonsCosmicTracking*','HLT_L1TrackerCosmics*'))   
