 ...
 *  write data from DQM summery file  into OMDS using Coral
 *  
 * 
 *  \author Michele de Gruttola (degrutto) - INFN Naples
 *
*/


// argv[1] is the .root file, imput for the python script, 
// argv[2] the .txt output file from the py script and imput to WriteDQMSummeryIntoOMDS::readData 

// i.g.: GetAndWriteDQMSummeryIntoOMDS DQM_R000043434.root tmp.txt
