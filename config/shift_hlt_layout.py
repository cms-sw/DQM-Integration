...
hltlayout(dqmitems,"00 Counts per muon HLT path",
  	[{'path': "HLT/HLTMonMuon/EfficiencySummary/CountHistos/hCountSummary", 'description': "event count per muon path. For more information please click 
<a href=\"https://twiki.cern.ch/twiki/bin/view/CMS/TriggerShiftHLTGuide\">here</a>."}])

hltlayout(dqmitems,"01 Path efficiencies wrt L1MuOpen",
  	[{'path': "HLT/HLTMonMuon/EfficiencySummary/hEffSummary", 'description': "Muon path efficiency with respect to the L1MuOpen. For more information 
please click <a 
