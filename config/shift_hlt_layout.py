...
hltlayout(dqmitems,"08 HLT_HcalHPDNoise_Pass_Any", [{'path': "HLT/TrigResults/PathsSummary/HLT Counts/HLT_HcalHPDNoise_Pass_Any", 'description': "Shows total number of HcalHPDNoise PD accepts and the total number of any HLT accepts in this PD. For more information please click <a href=\"https://twiki.cern.ch/twiki/bin/view/CMS/TriggerShiftHLTGuide\">here</a>."}])

hltlayout(dqmitems,"09 HLT_HcalNZS_Pass_Any", [{'path': "HLT/TrigResults/PathsSummary/HLT Counts/HLT_HcalNZS_Pass_Any", 'description': "Shows total number of HcalNZS PD accepts and the total number of any HLT accepts in this PD. For more information please click <a href=\"https://twiki.cern.ch/twiki/bin/view/CMS/TriggerShiftHLTGuide\">here</a>."}])
...
hltlayout(dqmitems,"13 HLT_MuEG_Pass_Any", [{'path': "HLT/TrigResults/PathsSummary/HLT Counts/HLT_MuEG_Pass_Any", 'description': "Shows total number of MuEG PD accepts and the total number of any HLT accepts in this PD. For more information please click <a href=\"https://twiki.cern.ch/twiki/bin/view/CMS/TriggerShiftHLTGuide\">here</a>."}])

hltlayout(dqmitems,"14 HLT_MuHad_Pass_Any", [{'path': "HLT/TrigResults/PathsSummary/HLT Counts/HLT_MuHad_Pass_Any", 'description': "Shows total number of MuHad PD accepts and the total number of any HLT accepts in this PD. For more information please click <a href=\"https://twiki.cern.ch/twiki/bin/view/CMS/TriggerShiftHLTGuide\">here</a>."}])

hltlayout(dqmitems,"15 HLT_MuOnia_Pass_Any", [{'path': "HLT/TrigResults/PathsSummary/HLT Counts/HLT_MuOnia_Pass_Any", 'description': "Shows total number of MuOnia PD accepts and the total number of any HLT accepts in this PD. For more information please click <a href=\"https://twiki.cern.ch/twiki/bin/view/CMS/TriggerShiftHLTGuide\">here</a>."}])

hltlayout(dqmitems,"16 HLT_MultiJet_Pass_Any", [{'path': "HLT/TrigResults/PathsSummary/HLT Counts/HLT_MultiJet_Pass_Any", 'description': "Shows total number of MultiJet PD accepts and the total number of any HLT accepts in this PD. For more information please click <a href=\"https://twiki.cern.ch/twiki/bin/view/CMS/TriggerShiftHLTGuide\">here</a>."}])

hltlayout(dqmitems,"17 HLT_Photon_Pass_Any", [{'path': "HLT/TrigResults/PathsSummary/HLT Counts/HLT_Photon_Pass_Any", 'description': "Shows total number of Photon PD accepts and the total number of any HLT accepts in this PD. For more information please click <a href=\"https://twiki.cern.ch/twiki/bin/view/CMS/TriggerShiftHLTGuide\">here</a>."}])

hltlayout(dqmitems,"18 HLT_PhotonHad_Pass_Any", [{'path': "HLT/TrigResults/PathsSummary/HLT Counts/HLT_PhotonHad_Pass_Any", 'description': "Shows total number of PhotonHad PD accepts and the total number of any HLT accepts in this PD. For more information please click <a href=\"https://twiki.cern.ch/twiki/bin/view/CMS/TriggerShiftHLTGuide\">here</a>."}])

hltlayout(dqmitems,"19 HLT_SingleElectron_Pass_Any", [{'path': "HLT/TrigResults/PathsSummary/HLT Counts/HLT_SingleElectron_Pass_Any", 'description': "Shows total number of SingleElectron PD accepts and the total number of any HLT accepts in this PD. For more information please click <a href=\"https://twiki.cern.ch/twiki/bin/view/CMS/TriggerShiftHLTGuide\">here</a>."}])

hltlayout(dqmitems,"20 HLT_SingleMu_Pass_Any", [{'path': "HLT/TrigResults/PathsSummary/HLT Counts/HLT_SingleMu_Pass_Any", 'description': "Shows total number of SingleMu PD accepts and the total number of any HLT accepts in this PD. For more information please click <a href=\"https://twiki.cern.ch/twiki/bin/view/CMS/TriggerShiftHLTGuide\">here</a>."}])

hltlayout(dqmitems,"21 HLT_Tau_Pass_Any", [{'path': "HLT/TrigResults/PathsSummary/HLT Counts/HLT_Tau_Pass_Any", 'description': "Shows total number of Tau PD accepts and the total number of any HLT accepts in this PD. For more information please click <a href=\"https://twiki.cern.ch/twiki/bin/view/CMS/TriggerShiftHLTGuide\">here</a>."}])

hltlayout(dqmitems,"22 HLT_TauPlusX_Pass_Any", [{'path': "HLT/TrigResults/PathsSummary/HLT Counts/HLT_TauPlusX_Pass_Any", 'description': "Shows total number of TauPlusX PD accepts and the total number of any HLT accepts in this PD. For more information please click <a href=\"https://twiki.cern.ch/twiki/bin/view/CMS/TriggerShiftHLTGuide\">here</a>."}])
