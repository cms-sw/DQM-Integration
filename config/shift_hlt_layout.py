...
hltlayout(dqmitems,"05 HLT Scalers",
  	[{'path': "HLT/HLTScalers_EvF/hltScalers", 'description': "HLT scaler for all hlt trigger paths. For more information please click <a href=\"https://twiki.cern.ch/twiki/bin/view/CMS/TriggerShiftHLTGuide\">here</a>."}])

hltlayout(dqmitems,"06 Counts per JetMET HLT path",
  	[{'path': "HLT/JetMET/All/rate_All", 'description': "Event triggered JetMET trigger paths . For more information please click <a href=\"https://twiki.cern.ch/twiki/bin/view/CMS/TriggerShiftHLTGuide\">here</a>."}])
