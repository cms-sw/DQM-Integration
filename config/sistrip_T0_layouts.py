...
sistriplayout(dqmitems, "02 - # of Cluster Trend",
  ...
  [{  'path':"SiStrip/MechanicalView/TEC/side_1/TotalNumberOfClusterProfile__TEC__side__1",
   ...
   {  'path':"SiStrip/MechanicalView/TEC/side_2/TotalNumberOfClusterProfile__TEC__side__2",
     'description': "Total # of Clusters in TEC +ve side with event time in Seconds  - <a href=https://twiki.cern.ch/twiki/bin/view/CMS/SiStripOnlineDQMInstructions>SiStripOnlineDQMInstructions</a> "}])
sistriplayout(dqmitems, "03 - OnTrackCluster (StoN)",
...
sistriplayout(dqmitems, "06 - Tracks (Cosmic Tracking)",
...
sistriplayout(dqmitems, "16 - TIB Cluster TkHMap",
...
sistriplayout(dqmitems, "17 - TOB Cluster TkHMap",
...
sistriplayout(dqmitems, "18 - TIDF Cluster TkHMap",
...
sistriplayout(dqmitems, "19 - TIDB Cluster TkHMap",
...
sistriplayout(dqmitems, "20 - TECF Cluster TkHMap",
...
sistriplayout(dqmitems, "21 - TECB Cluster TkHMap",
...
sistriplayout(dqmitems, "22 - TIB Residuals",
...
sistriplayout(dqmitems, "23 - TOB Residuals",
...
sistriplayout(dqmitems, "24 - TIDF Residuals",
...
sistriplayout(dqmitems, "25 - TIDB Residuals",
...
sistriplayout(dqmitems, "26 - TECF Residual",
...
sistriplayout(dqmitems, "27 - TECB Residual",
