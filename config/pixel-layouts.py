...
pixellayout(dqmitems, "04 - Pixel_Digi_Summary",
...
pixellayout(dqmitems, "05 - Pixel_Cluster_Summary",
...
pixellayout(dqmitems, "06 - Pixel_NoisyPixels_Summary",
  [{ 'path': "Pixel/Barrel/SUMDIG_ndigisFREQ_Barrel",
     'description': "Total number of events with at least one digi per event per barrel module - spikes show noisy modules or pixels!",
     'draw': { 'withref': "yes" }},
   { 'path': "Pixel/Endcap/SUMDIG_ndigisFREQ_Endcap",
...
pixellayout(dqmitems, "07 - Barrel_Digi_Occupancy_per_Shell",
...
pixellayout(dqmitems, "08 - Endcap_Digi_Occupancy_per_HalfCylinder",
...
pixellayout(dqmitems, "09 - Barrel_Digi_Summary_per_Shell",
...
pixellayout(dqmitems, "10 - Endcap_Digi_Summary_per_HalfCylinder",
