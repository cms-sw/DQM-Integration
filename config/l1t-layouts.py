...
l1t_gmt_single(dqmitems, "L1TGMT", "GMT_pt")
l1t_gmt_single(dqmitems, "L1TGMT", "GMT_qty")
l1t_gmt_single(dqmitems, "L1TGMT", "GMT_bits")
l1t_gmt_single(dqmitems, "L1TGMT", "etaphi_DTCSC_and_RPC")
l1t_gmt_single(dqmitems, "L1TGMT", "n_CSCTF_vs_DTTF")
l1t_gmt_single(dqmitems, "L1TGMT", "n_RPCf_vs_CSCTF")
...
l1t_gct_single(dqmitems, "L1T/L1TGCT", "IsoEmRank")
l1t_gct_single(dqmitems, "L1T/L1TGCT", "NonIsoEmRank")
l1t_gct_single(dqmitems, "L1T/L1TGCT", "EtMiss")
l1t_gct_single(dqmitems, "L1T/L1TGCT", "EtTotal")
l1t_gct_single(dqmitems, "L1T/L1TGCT", "EtHad")
...
l1t_rpctf_single(dqmitems, "L1TRPCTF", "RPCTF_muons_eta_phipacked")
...
l1t_rpctf_single(dqmitems, "L1TRPCTFClient", "RPCTF_phi_valuepacked_bad")
