...
if [ "$1" = "live" ] ; then
    ...
    ln -sf sistrip_dqm_sourceclient-live_cfg.py		dqmfu_06-2_cfg.py
    ln -sf fedtest_dqm_sourceclient-live_cfg.py		dqmfu_06-3_cfg.py
    ln -sf l1t_dqm_sourceclient-live_cfg.py		dqmfu_06-4_cfg.py
    ln -sf l1temulator_dqm_sourceclient-live_cfg.py	dqmfu_06-5_cfg.py
    ln -sf pixel_dqm_sourceclient-live_cfg.py		dqmfu_06-6_cfg.py
    ...
    ln -sf daq_dqm_sourceclient-live_cfg.py		dqmfu_07-6_cfg.py
    
    ln -sf ispy_dqm_sourceclient-live_cfg.py		dqmfu_08-1_cfg.py
    ln -sf hcal_dqm_sourceclient-live_cfg.py		dqmfu_08-2_cfg.py
    ln -sf hcaltiming_dqm_sourceclient-live_cfg.py	dqmfu_08-3_cfg.py
