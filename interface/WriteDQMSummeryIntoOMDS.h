#ifndef WriteDQMSUMMERYIntoOMDS_H
#define WriteDQMSUMMERYIntoOMDS_H

/*
 *  \class WriteDQMSummeryIntoRDB
 *  
 *  write data from DQM summery file into OMDS (relational db) using Coral 
 *  
...
class WriteDQMSummeryIntoOMDS : virtual public TestBase
{
public:
  WriteDQMSummeryIntoOMDS(
   ...
   virtual ~WriteDQMSummeryIntoOMDS();
   void run();
